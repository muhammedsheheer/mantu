...
export default function Menu() {
  ...
  return (
    <section className="bg-menubg mt-8 flex w-full flex-row px-40">
      ...
      <div className="flex w-full flex-col gap-4 md:w-4/6">
        <div
          ...
          style={{
            background:
              "linear-gradient(170deg, rgba(0, 0, 0, 0.00) 7.51%, rgba(0, 0, 0, 0.80) 92.93%), url('/images/menu.jpg') lightgray 50% / cover no-repeat",
          }}
        >
