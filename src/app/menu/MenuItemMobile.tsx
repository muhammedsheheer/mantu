...
const MenuItemMobile: FC<MenuItemProps> = ({ id }) => {
  ...
  return (
    item && (
      <section className="z-10 flex h-fit w-full flex-row items-center overflow-hidden bg-[#111] px-2 py-2">
        <div
          className={cn(
        ...
        >
          <div className="flex w-full flex-col gap-2">
            ...
            >
              <MenuItemDrawer item={item} setChoose={setOpen}>
                <p className="bg-menusecondary-foreground text-menuprimary mt-3 w-fit rounded-3xl p-2 px-3 py-3 text-base font-medium leading-[80%] tracking-[1px]">
